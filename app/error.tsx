...
export default function Page() {
    ...
    return (
        <div className="text-center grid place-items-center">
            ...
            <div className="flex gap-2 mt-5 bg-blue-500 text-white px-4 py-2 rounded-lg cursor-pointer" onClick={onRetry}>
                <Image width={15} height={15} src="/images/icon-retry.svg" alt="Retry" />
                <button className="font-dmSans cursor-pointer">Try Again</button>
            </div>
        </div >
    )
}